...
import { LayoutDashboard, Package, Tags, Image as ImageIcon, Settings, LogOut, ExternalLink, MapPin } from "lucide-react";
...
const nav = [
  ...
  { to: "/admin/hotspots", label: "Pins Interativos", icon: MapPin },
